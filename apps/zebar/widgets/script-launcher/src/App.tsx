...
import { UpdateScriptModal } from '@petehome/config-widget';
import { LauncherCommand } from '@petehome/config/src/types';
import { generateId } from '@petehome/config/src/utils/generateId';
import { logger } from '@petehome/config/src/utils/logger';
import {
  Button,
  ContextMenu,
  ContextMenuContent,
