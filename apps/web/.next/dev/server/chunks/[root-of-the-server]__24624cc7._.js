...
"[project]/lib/spotify-auth.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getAuthenticatedSpotifyService",
    ()=>getAuthenticatedSpotifyService,
    "isSpotifyConfigured",
    ()=>isSpotifyConfigured
]);
...
async function getAuthenticatedSpotifyService() {
    const spotifyService = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$spotify$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SpotifyService"]();
    ...
    if (needsRefresh && refreshToken) {
        try {
            ...
            // Save to file storage (for cross-origin requests)
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$token$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setSpotifyTokens"])({
                access_token: tokens.access_token,
                refresh_token: tokens.refresh_token || refreshToken,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$token$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clearSpotifyTokens"])();
...
"[project]/lib/sync/background-sync.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$spotify$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/spotify-auth.ts [app-route] (ecmascript)");
;
;
;
;
...
async function syncHue() {
    ...
    try {
        const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adapters$2f$hue$2e$adapter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHueAdapter"])();
...
async function syncSpotifyHistory() {
    ...
    try {
        ...
        const { service: spotifyService, authenticated } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$spotify$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthenticatedSpotifyService"])();
        if (!authenticated) {
            return {
                service: 'spotify-history',
                success: false,
...
async function syncCTA() {
    const start = Date.now();
    try {
        const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adapters$2f$cta$2e$adapter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCTAAdapter"])();
        if (!adapter.isConfigured()) {
            return {
                service: 'cta',
                success: false,
...
async function syncCalendar() {
    const start = Date.now();
    try {
        const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adapters$2f$calendar$2e$adapter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCalendarAdapter"])();
        if (!adapter.isConfigured()) {
            return {
                service: 'calendar',
                success: false,
...
async function syncAll() {
    ...
    // Check preconditions
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocalMode"])()) {
        return {
            success: false,
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) {
        return {
            success: false,
            totalRecordsWritten: 0,
            services: [],
...
async function syncUnauthenticated() {
    const start = Date.now();
    const timestamp = new Date().toISOString();
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocalMode"])() || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) {
        return {
            success: false,
            totalRecordsWritten: 0,
            services: [],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sync/background-sync.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/mode.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-route] (ecmascript)");
;
;
...
async function GET() {
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])({
            mode: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocalMode"])() ? 'local' : 'production',
            supabaseConfigured: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])(),
            canSync: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocalMode"])() && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])(),
            services: [
                'hue',
                'cta',
                'fitness',
...
async function POST(request) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$mode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocalMode"])()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Sync only available in local mode", 403);
        }
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Supabase not configured", 400);
        }
        ...
        if (service && service !== 'all') {
            ...
            switch(service){
                case 'hue':
                    result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncHue"])();
                    break;
                case 'cta':
                    result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncCTA"])();
                    break;
                case 'fitness':
                    result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncFitness"])();
                    break;
                default:
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(`Unknown service: ${service}`, 400);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(result);
        }
        // Sync all services
        if (includeAuth) {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncAll"])();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(result);
        } else {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sync$2f$background$2d$sync$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncUnauthenticated"])();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(result);
        }
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24624cc7._.js.map