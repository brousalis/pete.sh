...
"[project]/app/api/cta/all/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { config } = await __turbopack_context__.A("[project]/lib/config.ts [app-route] (ecmascript, async loader)");
        if (!config.cta.isConfigured && !config.cta.isTrainConfigured) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("CTA API keys not configured. Please set CTA_API_KEY and/or CTA_TRAIN_API_KEY", 400);
        }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(results);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8aa34ebe._.js.map