...
"[project]/lib/services/workout-autocomplete.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class WorkoutAutocompleteService {
   ...
   */ async triggerAutocomplete(context) {
        ...
        try {
            ...
            const fitnessAdapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adapters$2f$fitness$2e$adapter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFitnessAdapter"])();
            ...
            const sectionsCompleted = [
                ...new Set(matches.map((m)=>m.section))
            ];
            ...
            await this.linkWorkoutToExercises(healthkitWorkoutId, workout.id, linkedDay, weekNumber, year, matches);
            return {
                success: true,
   ...
   */ mapWorkoutTypeToExercises(workoutType, workout, duration) {
        const matches = [];
   ...
   */ async linkWorkoutToExercises(healthkitWorkoutId, routineId, dayOfWeek, weekNumber, year, matches) {
        ...
        try {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const { error } = await supabase.from('exercise_healthkit_links').upsert(records, {
   ...
   */ async getLinkedWorkoutsForDay(dayOfWeek, weekNumber, year) {
        ...
        try {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const { data, error } = await supabase.from('exercise_healthkit_links').select('exercise_id, healthkit_workout_id').eq('day_of_week', dayOfWeek).eq('week_number', weekNumber).eq('year', year);
            if (error) {
                console.error('[WorkoutAutocomplete] Error fetching links:', error);
                return new Map();
            }
            // Group by exercise_id -> workout_ids
            const exerciseToWorkouts = new Map();
   ...
   */ async getLinkedWorkoutDetails(workoutIds) {
        ...
        try {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const { data, error } = await supabase.from('apple_health_workouts').select(`
          id,
          workout_type,
          start_date,
          end_date,
...
const workoutAutocompleteService = new WorkoutAutocompleteService();
}),
"[project]/app/api/fitness/workout/[day]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adapters$2f$fitness$2e$adapter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/adapters/fitness.adapter.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$workout$2d$autocomplete$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/workout-autocomplete.service.ts [app-route] (ecmascript)");
;
;
;
async function GET(request, { params }) {
    try {
        ...
        if (!workout) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(null);
        }
        ...
        const exerciseToWorkouts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$workout$2d$autocomplete$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["workoutAutocompleteService"].getLinkedWorkoutsForDay(day, weekNumber, year);
        // Get unique workout IDs and fetch their details
        const allWorkoutIds = [
            ...new Set([
                ...exerciseToWorkouts.values()
            ].flat())
        ];
        const workoutDetails = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$workout$2d$autocomplete$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["workoutAutocompleteService"].getLinkedWorkoutDetails(allWorkoutIds);
        // Build the linked workouts map: exerciseId -> workout summaries
        const linkedHealthKitWorkouts = {};
        for (const [exerciseId, workoutIds] of exerciseToWorkouts.entries()){
            linkedHealthKitWorkouts[exerciseId] = workoutIds.map((id)=>workoutDetails.get(id)).filter((w)=>w !== undefined).map((w)=>({
                    id: w.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f98a350b._.js.map