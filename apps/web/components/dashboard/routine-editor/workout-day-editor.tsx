...
const SECTIONS: SectionConfig[] = [
  {
    key: 'warmup',
    label: 'Warm-up',
    icon: <Flame className="h-4 w-4 text-accent-ember" />,
    accentColor: 'text-accent-ember',
    badgeClass: 'bg-accent-ember/15 text-accent-ember border-accent-ember/20',
  },
  {
    key: 'exercises',
    label: 'Main Workout',
    icon: <Dumbbell className="h-4 w-4 text-accent-azure" />,
    accentColor: 'text-accent-azure',
    badgeClass: 'bg-accent-azure/15 text-accent-azure border-accent-azure/20',
  },
  {
    key: 'finisher',
    label: 'Finisher',
    icon: <Zap className="h-4 w-4 text-accent-violet" />,
    accentColor: 'text-accent-violet',
    badgeClass: 'bg-accent-violet/15 text-accent-violet border-accent-violet/20',
  },
  {
    key: 'metabolicFlush',
    label: 'Metabolic Flush',
    icon: <Wind className="h-4 w-4 text-accent-sage" />,
    accentColor: 'text-accent-sage',
    badgeClass: 'bg-accent-sage/15 text-accent-sage border-accent-sage/20',
  },
  {
    key: 'mobility',
    label: 'Mobility',
    icon: <StretchHorizontal className="h-4 w-4 text-accent-teal" />,
    accentColor: 'text-accent-teal',
    badgeClass: 'bg-accent-teal/15 text-accent-teal border-accent-teal/20',
  },
]
